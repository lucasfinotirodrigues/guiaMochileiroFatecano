...
export class ResumosComponent implements OnInit {
  ...
  trackId = (_index: number, item: IResumos): number => this.resumosService.getResumosIdentifier(item);
  ...
  delete(resumos: IResumos): void {
    const modalRef = this.modalService.open(ResumosDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.resumos = resumos;
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.resumos = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IResumos[] | null): IResumos[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.resumosService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
