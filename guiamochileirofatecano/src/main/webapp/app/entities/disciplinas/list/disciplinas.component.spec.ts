...
describe('Disciplinas Management Component', () => {
  let comp: DisciplinasComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'disciplinas', component: DisciplinasComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(DisciplinasComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to disciplinasService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDisciplinasIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDisciplinasIdentifier).toHaveBeenCalledWith(entity);
