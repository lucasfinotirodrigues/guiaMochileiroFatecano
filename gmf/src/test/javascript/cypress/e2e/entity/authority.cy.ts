...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '309708e0-3cff-46fa-8e33-26dec72bd808' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('c3d34069-c4dd-4c44-a8f6-ea1712f3df31');
      cy.get(`[data-cy="name"]`).should('have.value', 'c3d34069-c4dd-4c44-a8f6-ea1712f3df31');
